...
import com.project.microservices.StatisticsMicroservice.daos.StatisticsDao;
import com.project.microservices.StatisticsMicroservice.entities.Statistics;
import com.project.microservices.StatisticsMicroservice.utilities.JsonResponseBody;
...
public class StatisticsServiceImpl implements StatisticsService {
    ...
    public List<Statistics> getStatistics(String jwt, String email){
        ...
        if(statistics.size()>0){
            ...
            if(days>1){
                statistics.add(statisticsDao.save(new Statistics(statisticsDescr, new Date(), email)));
            }
        }
    ...
    private List<LinkedHashMap> getNewDataFromToDoMicroservice(String jwt){
        ...
        List todoList = (List) responseEntity.getBody().getResponse();
